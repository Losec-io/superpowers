...
digraph process {
    ...
    "Read plan, extract all tasks with full text, note context, track progress" [shape=box];
    "More tasks remain?" [shape=diamond];
    "Dispatch final code reviewer subagent for entire implementation" [shape=box];
    "Use superpowers:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];

    "Read plan, extract all tasks with full text, note context, track progress" -> "Dispatch implementer subagent (./implementer-prompt.md)";
...
[Track all tasks (TodoWrite on Claude Code, update_plan on Codex)]
